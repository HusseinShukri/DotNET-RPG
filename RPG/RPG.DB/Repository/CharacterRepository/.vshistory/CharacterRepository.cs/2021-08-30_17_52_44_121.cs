...
namespace RPG.Data.Repository.CharacterRepository
{
    public class CharacterRepository : ICharacterRepository
    {
        ...
        public async Task<CharacterDto> AddCharacterSkill(AddCharacterSkill newCharacterSkill, int userId)
        {
            var character = await _dataContext.Character.FirstOrDefaultAsync(c => c.Id == newCharacterSkill.CharacterId && c.UserId == userId));
            ...
            response.Data = await _characterRepository.GetCharacterById(character.Id, userId);
