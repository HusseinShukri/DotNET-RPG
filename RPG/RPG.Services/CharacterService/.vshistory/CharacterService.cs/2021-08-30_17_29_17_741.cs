...
namespace RPG.Services.CharacterService
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<GetCharacterDto>> AddCharacterSkill(AddCharacterSkill newCharacterSkill, int userId)
        {
            ...
            _characterRepository.UpdateCharacter(character, userId);
