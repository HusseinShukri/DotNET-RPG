...
namespace RPG.Services.CharacterServices
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<List<GetCharacterDto>>> AddCharacter(AddCharacterDto newCharacter)
        {
            ...
            serviceResponse.Data = await _characterRepository.AddCharacter(newCharacter);
            if (serviceResponse.Data == null)
            {
                serviceResponse.Message = "There Is No Characters";
            }
            if (serviceResponse.Data != null)
            {
        ...
        public async Task<ServiceResponse<List<GetCharacterDto>>> DeleteCharacters(int id)
        {
            ...
            serviceResponse.Data = await _characterRepository.DeleteCharacters(id);
            if (serviceResponse.Data != null)
            {
